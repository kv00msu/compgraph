...
/*! @brief The textt input I-beam cursor shape.
 *
 *  The textt input I-beam cursor shape.
 */
 ...
 *  input textt, use the Unicode character callback instead.
 *
 *  The [modifier key bit masks](@ref mods) are not key tokens and cannot be
 *  used with this function.
 *
 *  __Do not use this function__ to implement [textt input](@ref input_char).
 *
 ...
 *  layout.  If you want to input textt, use the
 ...
 *
 *  The character callback is intended for Unicode textt input.  As it deals with
 ...
 *
 *  The character callback behaves as system textt input normally does and will
 *  not be called if modifier keys are held down that would prevent normal textt
 ...
 *  Unicode character input.  For regular Unicode textt input, see the
